...
export default ({
  ...
  tabs = {
    Vegetable:getRandomCards(),
    Fruit: getRandomCards(),
    Green: getRandomCards(),
    Seasonal: getRandomCards()
  }
}) => {
  /*
  ...
  useEffect(() => {
    const getData=async()=>{
      await Axios.get('https://shahbasket.herokuapp.com/product/all')
      .then(res => 
        {
  ...
  return (
    <Container>
      ...
      <PrimaryButton buttonRounded={true} as="a" href={"#download"}>
             Shop Now
            </PrimaryButton>
